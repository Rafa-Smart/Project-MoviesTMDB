...
document.querySelector(".trending-button").addEventListener("click", function (e) {
  cariFilm();
});

  const input = document.querySelector(".trending-pilih");
...
function cariFilm() {
  const input = document.querySelector(".trending-pilih").value;
  ...
  let containerLama = document.querySelector(".container-trending");
  if (containerLama) {
  ...
  divKonten.className = "container-trending";
...
function ambilData(data) {
  ...
  const request = new Request(
    `https://api.themoviedb.org/3/trending/movie/${data}`,
    config
  );
      ...
      e.poster_path
        ...
        <div class="card-item-trending">
          ...
          <div class="preview-film-trending">
            ...
            <p class="preview-film-trending-trending">
